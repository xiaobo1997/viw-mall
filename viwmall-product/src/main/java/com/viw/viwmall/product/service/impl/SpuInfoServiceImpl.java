...
import com.viw.common.to.SpuBoundTo;
import com.viw.common.to.es.SkuEsModel;
import com.viw.common.utils.R;
import com.viw.viwmall.product.entity.*;
import com.viw.viwmall.product.feign.CouponFeignService;
import com.viw.viwmall.product.feign.SearchFeignService;
import com.viw.viwmall.product.feign.WareFeignService;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public static String className = SpuInfoServiceImpl.class.getName();
     ...
     * TODO 需要完善各种失败场景，服务调用失败等，分布式事务
     * @param vo
     */
    @Transactional
    @Override
    public void saveSpuInfo(SpuSaveVo vo) {
        System.out.println("开始保存商品:" + vo.toString());
        //1、保存spu基本信息 pms_spu_info
        ...
        if (skus != null && skus.size() > 0) {
            skus.forEach(item -> {
                ...
                // 满减=<0 就不调用 优惠券服务  compareTo 返回 -1  说明 给的数 比 0 小
    ...
    public void up(Long spuId) {
        ...
        //TODO 5、将数据发送给es进行保存；viwmall-search；
